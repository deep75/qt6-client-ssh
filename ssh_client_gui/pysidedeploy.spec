...
# python path
# adjust to your own venv, e.g. the output of `uv venv` at the repo root
python_path = python3
...
qml_files = qml/ConnectionForm.qml,qml/Main.qml,qml/OutputPanel.qml
